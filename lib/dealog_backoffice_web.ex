defmodule DealogBackofficeWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: DealogBackofficeWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/dealog_backoffice_web/templates",
        namespace: DealogBackofficeWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {DealogBackofficeWeb.LayoutView, "live.html"}
